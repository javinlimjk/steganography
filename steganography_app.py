...
class SteganographyApp:
    def __init__(self, root):
        ...
        self.scrollable_frame = ScrollableFrame(self.root, bg_color="#f7f7f7")
        self.scrollable_frame.pack(fill="both", expand=True)

        # Now use self.scrollable_frame.scrollable_frame as the parent
        main_frame = self.scrollable_frame.scrollable_frame

        # Frame for file selection
        self.frame = tk.Frame(main_frame, bg="#ffffff", padx=20, pady=20)
        ...
        self.original_frame = tk.Frame(
            main_frame, bg="#e0e0e0", padx=10, pady=10)
